...
export type KZApi = {
  ...
  file: { read: (root: string, path: string) => Promise<string>; write: (root: string, path: string, content: string) => Promise<void>; create: (root: string, path: string, kind: 'file' | 'folder') => Promise<void>; remove: (root: string, path: string) => Promise<void>; rename: (root: string, oldPath: string, newPath: string) => Promise<void> };
